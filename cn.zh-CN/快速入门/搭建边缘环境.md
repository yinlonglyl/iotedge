...
3.  创建产品名为**边缘计算节点**的网关产品。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/15284/15390866197299_zh-CN.png)
...
2.  启动边缘计算节点。
    ...
    **说明：** 
    ...
    -   请将\{version\}替换为需要的Docker镜像版本号，此处替换为v1.5。
...
3.  在[物联网控制台](http://iot.console.aliyun.com/)，选择**设备管理**，选择已创建好的边缘计算节点产品，查看网关状态。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/15286/15390866196743_zh-CN.png)
