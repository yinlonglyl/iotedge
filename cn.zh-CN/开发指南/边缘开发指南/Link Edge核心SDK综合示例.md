# Link Edge核心SDK综合示例 {#concept_t2k_2hp_32b .concept}

本文展示使用Link Edge核心SDK控制灯设备的操作代码。示例中，当光照传感器上报的光照度超过500时关闭灯，光照度不足100时打开灯。

## Node.js版本综合示例 {#section_fvm_xdf_h2b .section}
